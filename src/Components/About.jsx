...
export default function About(props) {
    ...
    return (
        <div className=' text-white w-11/12 m-auto' name={props.name}>
            <h1 className="text-center text-3xl font-extrabold mb-6">{t('about_header')}</h1>
            <div className="text-center m-auto max-w-7xl ">
                {t("about_body")}
            </div>
